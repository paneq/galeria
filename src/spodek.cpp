...
const float Spodek::Pi = 3.1415926535897932384626433832795f;
...
/*
Spodek* Spodek::rotate(float alfa, float dx, float dy, float dz){
...
Spodek* Spodek::translate(float dx, float dy, float dz){
    if ( !getUzylStos() ){
        glPushMatrix();
        glLoadIdentity();
    };
...
Spodek* Spodek::scale(float sx, float sy, float sz){
